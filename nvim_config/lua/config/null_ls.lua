...
function M.setup()
    ...
    null_ls.setup({
        ...
        sources = {
            ...
            null_ls.builtins.code_actions.eslint_d, --  npm install -g eslint_d
            null_ls.builtins.diagnostics.flake8, -- pip3 install flake8
            null_ls.builtins.formatting.black, -- pip3 install black
        },
    })
end
